...
export async function setECSHtml(
  ...
  try {
    ...
    const runJsPath = vscode.Uri.joinPath(baseUri, "dist", "webViews", "charts", "ecs.js");
    ...
    console.error("Failed to set ECS HTML content:", error);
    vscode.window.showErrorMessage("An error occurred while setting up the ECS dashboard.");
  }
}
