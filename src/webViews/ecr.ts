...
export async function setECRHtml(
  ...
  try {
    ...
    const runJsPath = vscode.Uri.joinPath(baseUri, "dist", "webViews", "charts", "ecr.js");
    ...
    console.error("Failed to set ECR HTML content:", error);
    vscode.window.showErrorMessage("An error occurred while setting up the ECR dashboard.");
  }
}
