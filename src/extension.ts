...
function registerTreeDataProviders(profileProvider: ProfileProvider, regionProvider: RegionProvider, serviceProvider: ServiceProvider): void {
...
function registerCommands(context: vscode.ExtensionContext, profileProvider: ProfileProvider, regionProvider: RegionProvider, viewProvider: WebViewProvider): void {
  const commands = [
    {
    ...
    {
        name: 'cloudtoolbox.showEventBridge',
        callback: (): void => {
